...
- [ ] 9. 統合と検証
- [x] 9.1 ライフサイクルとマイグレーション安全性の統合テストを追加する
...
- [x] 9.3 テスト分離と graceful shutdown の検証テストを追加する
